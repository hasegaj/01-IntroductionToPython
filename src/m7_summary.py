...
nerp = rg.SimpleTurtle('turtle')
nerp.pen = rg.Pen('blue', 11)

nerp.go_to(rg.Point(0, 200))

nerp.pen_up()
nerp.go_to(rg.Point(100, -40))
nerp.pen_down()

nerp.pen = rg.Pen('green', 10)

nerp.go_to(rg.Point(100, -190))
